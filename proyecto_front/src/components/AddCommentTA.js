...
export const AddCommentTA = ({ user, otherId, title , placeholder , onRatingCreated , onRatingUpdated }) => {
    ...
    const postComment = async () => {
        ...
        await ratingsService.createOpinionToArtist({
    ...
    const fetchPreviousRating = async () => {
        ...
        const rating = await  ratingsService.getMyRatingsForArtistIdBd(otherId)
